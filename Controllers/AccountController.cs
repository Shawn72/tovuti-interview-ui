...
namespace TovutiUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController( UserManager<UserModel> userManager, SignInManager<UserModel> signInManager, DatabaseContext _context, IConfiguration config, IEmailSender emailSender)
        {
